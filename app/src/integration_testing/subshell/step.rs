...
use octomusui::integration::{AssertionOutcome, TestStep};
use octomusui::{async_assert, async_assert_eq};
use regex::Regex;
...
pub fn assert_subshell_banner_is_showing() -> TestStep {
    TestStep::new("Assert the Octomusify banner is visible")
        .add_assertion(move |app, window_id| {
            ...
            terminal_view.read(app, |view, _ctx| {
                async_assert!(matches!(
                    view.model
                        ...
                        .active_block()
                        .block_banner(),
                    Some(WithinBlockBanner::OctomusifyBanner(..))
                ))
            })
        })
                ...
                match rich_content_type {
                    ...
                    _ => {
                        return AssertionOutcome::failure(
                            "Octomusify success block wasn't added to the blocklist".to_owned(),
                        );
                    }
                }
