...
fn init_test_app(ctx: &mut octomusui::AppContext) {
...
fn test_migration_copies_public_settings_from_native_store() {
    octomusui::App::test((), |mut app| async move {
...
mod notifications_migration {
    ...
    pub fn init_notifications_migration_test_app(ctx: &mut octomusui::AppContext) {
        ctx.add_singleton_model(move |_| {
