...
impl PaneId {
    ...
    pub(super) fn deferred_placeholder_pane_id() -> Self {
        Self(IPaneId {
            ...
            pane_view_id: octomusui::EntityId::new(),
        })
    }
    ...
    pub fn is_octomus_drive_object_pane(&self) -> bool {
        matches!(
            self.0.pane_type,
            IPaneType::Notebook
                | IPaneType::Workflow
    ...
    pub fn render(self, app: &AppContext) -> Box<dyn Element> {
        let mut element = match self.0.pane_type {
            ...
            IPaneType::DeferredPlaceholder => octomusui::elements::Empty::new().finish(),
            #[cfg(test)]
            IPaneType::Dummy => octomusui::elements::Empty::new().finish(),
        };
