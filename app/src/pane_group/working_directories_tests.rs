...
fn refresh_working_directories_collapses_subroots_to_nearest_repo_root() {
    App::test((), |mut app| async move {
        ...
        // Use dunce::canonicalize to match the behavior of octomus_util::standardized_path::StandardizedPath and normalize_cwd,
...
fn setup_repo(
    app: &mut octomusui::App,
    detected_repos: &octomusui::ModelHandle<DetectedRepositories>,
) -> (
    tempfile::TempDir,
    PathBuf,
    PathBuf,
    octomusui::ModelHandle<WorkingDirectoriesModel>,
) {
