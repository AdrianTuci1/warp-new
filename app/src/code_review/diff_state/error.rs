...
//!   through [`octomus_core::report_error!`] or code-review telemetry keeps logs,
...
use octomus_core::errors::{AnyhowErrorExt, ErrorExt};
use octomus_core::sync_queue::IsTransientError;
...
octomus_core::errors::register_error!(DiffStateError);
