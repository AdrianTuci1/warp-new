    ...
    fn new_for_test(
        ...
        Self {
            remote_path: RemotePath::new(
                ...
                octomus_util::standardized_path::StandardizedPath::try_new("/test/repo")
...
fn initialize_test_app(app: &mut octomusui::App) {
...
fn session_disconnected_is_ignored_by_session_agnostic_model() {
    ...
    octomusui::App::test((), |mut app| async move {
        ...
        let event = RemoteServerManagerEvent::SessionDisconnected {
            session_id: octomus_core::SessionId::default(),
            host_id: remote_server::HostId::new("test-host".to_string()),
            exit_status: None,
