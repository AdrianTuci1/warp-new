...
define_settings_group!(GeneralSettings, settings: [
    ...
    open_in_octomus_banner_dismissed_for_markdown: OpenInWarpBannerDismissedMarkdown {
        type: bool,
        default: false,
        supported_platforms: SupportedPlatforms::ALL,
        sync_to_cloud: SyncToCloud::Never,
    ...
    open_in_octomus_banner_dismissed_for_code_and_text: OpenInWarpBannerDismissedCode {
        type: bool,
        default: false,
        supported_platforms: SupportedPlatforms::ALL,
        sync_to_cloud: SyncToCloud::Never,
    ...
    did_check_to_trigger_openoctomus_launch_modal: DidShowOpenWarpLaunchModal {
        type: bool,
        default: false,
        supported_platforms: SupportedPlatforms::ALL,
