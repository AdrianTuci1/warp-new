    ...
    fn render_content(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let explanation_fragments = vec![
            ...
            FormattedTextFragment::hyperlink(
                "Learn more",
                "https://docs.octomus.dev/support-and-community/plans-and-billing/add-on-credits#id-2.-enable-auto-reload",
            ),
        ];
        let explanation_text = octomusui::elements::FormattedTextElement::new(
        ...
        .register_default_click_handlers_with_action_support(|hyperlink_lens, _event, ctx| {
            match hyperlink_lens {
                ...
                octomusui::elements::HyperlinkLens::Action(_action_ref) => {}
            }
        })
        .finish();
...
impl octomusui::TypedActionView for EnableAutoReloadModalBody {
    type Action = Action;
...
impl octomusui::TypedActionView for EnableAutoReloadModal {
    type Action = ();
}
