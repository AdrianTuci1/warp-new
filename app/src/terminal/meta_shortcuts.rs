...
/// Whether this keystroke should dispatch an action in Octomus despite the
/// [`octomusui::event::Event::KeyDown::is_composing`] being true.
///
...
///
/// This function is intended to be used when handling [`octomusui::event::Event::KeyDown`] when its
