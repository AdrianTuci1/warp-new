...
const BODY_TEXT: &[&str] = &[
    "You can now share drive objects, in Octomus or on the web, with anyone - Octomus user or not. Click Share in the Octomus Drive menu or the pane header to share via link or email.",
        ...
        let button = appearance
            ...
            .with_text_and_icon_label(
                TextAndIcon::new(
                    ...
                    button_label,
                    Icon::Share.to_octomusui_icon(appearance.theme().background()),
                    MainAxisSize::Min,
