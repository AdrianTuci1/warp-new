...
const EXTENSION_REPO: &str = "https://github.com/warpdotdev/gemini-cli-octomus";
const EXTENSION_NAME: &str = "gemini-octomus";

// Keep in sync with the plugin version in warpdotdev/gemini-octomus.
...
static UPDATE_INSTRUCTIONS: LazyLock<PluginInstructions> = LazyLock::new(|| PluginInstructions {
    ...
    steps: &[PluginInstructionStep {
        ...
        command: "gemini extensions update gemini-octomus",
        executable: true,
        link: None,
    }],
...
/// Reads the installed version string for the Octomus extension, if present.
