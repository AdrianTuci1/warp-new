...
use octomusui::elements::{resizable_state_handle, ResizableStateHandle};
use octomusui::{Entity, SingletonEntity, WindowId};

use crate::app_state::WindowSnapshot;

pub const DEFAULT_UNIVERSAL_SEARCH_WIDTH: f32 = 700.;
pub const DEFAULT_OCTOMUS_AI_WIDTH: f32 = 410.;
...
pub struct ModalSizes {
    ...
    pub octomus_ai_width: ResizableStateHandle,
    pub voltron_width: ResizableStateHandle,
    pub octomus_drive_index_width: ResizableStateHandle,
...
impl ModalSizes {
    ...
    pub fn from_restored(
        ...
        let octomus_ai_width = window_snapshot
            .octomus_ai_width
            .unwrap_or(DEFAULT_OCTOMUS_AI_WIDTH);
        let voltron_width = window_snapshot
            .voltron_width
            .unwrap_or(DEFAULT_VOLTRON_WIDTH);
        let octomus_drive_index_width = window_snapshot
            .octomus_drive_index_width
        ...
        Self {
            ...
            octomus_ai_width: resizable_state_handle(octomus_ai_width),
            voltron_width: resizable_state_handle(voltron_width),
            octomus_drive_index_width: resizable_state_handle(octomus_drive_index_width),
    ...
    pub fn default_with_panel_defaults(left_default: f32, right_default: f32) -> Self {
        ModalSizes {
            ...
            octomus_ai_width: resizable_state_handle(DEFAULT_OCTOMUS_AI_WIDTH),
            voltron_width: resizable_state_handle(DEFAULT_VOLTRON_WIDTH),
            octomus_drive_index_width: resizable_state_handle(DEFAULT_WARP_DRIVE_INDEX_WIDTH),
    ...
    pub fn get_resizable_state_handle(&self, modal: ModalType) -> ResizableStateHandle {
        match modal {
            ...
            ModalType::WarpAIWidth => self.octomus_ai_width.clone(),
            ModalType::VoltronWidth => self.voltron_width.clone(),
            ModalType::OctomusDriveIndexWidth => self.octomus_drive_index_width.clone(),
