//! Logic relating to a secondary process which Octomus uses to spawn new shell
//! sessions.
//!
...
//! early during Octomus's initialization, we can be more confident that there are
...
pub fn run_terminal_server(args: &octomus_cli::TerminalServerArgs) {
...
/// between processes, enabling the Octomus application process to communicate
    ...
    pub fn new() -> Result<Self> {
        ...
        unsafe {
            ...
            let server = Command::new(program)
                ...
                .arg(octomus_cli::terminal_server_subcommand())
