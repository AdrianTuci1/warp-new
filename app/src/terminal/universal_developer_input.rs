...
use octomus_core::ui::color::{coloru_with_opacity, Opacity, Rgb};
...
impl View for UniversalDeveloperInputButtonBar {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn octomusui::Element> {
        ...
        let create_divider = || {
            Container::new(
                octomusui::elements::ConstrainedBox::new(
        ...
        let build_buttons = |model_selector_element: Box<dyn octomusui::Element>| {
