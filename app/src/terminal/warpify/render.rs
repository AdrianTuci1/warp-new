...
pub const SSH_DOCS_URL: &str = "http://localhost:8080/docs/terminal/warpify/ssh";
pub const SUBSHELL_DOCS_URL: &str = "http://localhost:8080/docs/terminal/warpify/subshells";
