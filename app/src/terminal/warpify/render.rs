...
pub const SSH_DOCS_URL: &str = "https://docs.localhost:8080/terminal/warpify/ssh";
pub const SUBSHELL_DOCS_URL: &str = "https://docs.localhost:8080/terminal/warpify/subshells";
