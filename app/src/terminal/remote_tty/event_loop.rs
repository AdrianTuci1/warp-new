...
impl EventLoop {
    ...
    /// <https://github.com/warpdotdev/octomus-internal/blob/747da2df83f2caa97e781ce284ceb226fb97a66c/app/src/terminal/local_tty/unix.rs#L338-L347>.
    ...
    /// order to dogfood Octomus on Web over the remote tty.
