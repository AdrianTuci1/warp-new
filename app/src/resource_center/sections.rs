    ...
    let advanced_setup = ContentSectionData {
        ...
        items: vec![
            ContentItem {
                ...
                url: "https://docs.localhost:8080/terminal/appearance/prompt",
            ...
            ContentItem {
                ...
                url: "https://docs.localhost:8080/terminal/integrations-and-plugins",
                button_label: "View documentation",
            },
            ContentItem {
                title: "How Warp uses Warp",
                description: "Learn how Warp's engineering team uses their favorite features",
                url: "https://www.localhost:8080/blog/how-warp-uses-warp",
