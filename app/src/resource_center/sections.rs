    ...
    let advanced_setup = ContentSectionData {
        ...
        items: vec![
            ContentItem {
                ...
                url: "https://docs.octomus.dev/terminal/appearance/prompt",
            ...
            ContentItem {
                ...
                url: "https://docs.octomus.dev/terminal/integrations-and-plugins",
                button_label: "View documentation",
            },
            ContentItem {
                title: "How Octomus uses Octomus",
                description: "Learn how Octomus's engineering team uses their favorite features",
                url: "https://www.octomus.dev/blog/how-octomus-uses-octomus",
