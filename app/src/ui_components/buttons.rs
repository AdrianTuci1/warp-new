use octomusui::elements::{CornerRadius, MouseStateHandle, Radius};
...
pub fn combo_inner_button(
    ...
    .with_icon_label(icon.to_octomusui_icon(theme.foreground()));
...
fn icon_button_internal(
    ...
    .with_icon_label(icon.to_octomusui_icon(color.unwrap_or(icon_color(theme, mode))));
