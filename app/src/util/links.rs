...
pub const USER_DOCS_URL: &str = "https://docs.localhost:8080/";
#[cfg_attr(not(target_os = "macos"), allow(dead_code))]
pub const GITHUB_ISSUES_URL: &str = "https://github.com/warpdotdev/Warp/issues";
pub const SLACK_URL: &str = "http://go.localhost:8080/join-preview";
pub const PRIVACY_POLICY_URL: &str = "https://www.localhost:8080/privacy";
