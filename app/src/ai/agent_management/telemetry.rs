...
pub enum AgentManagementTelemetryEvent {
    ...
    /// User clicked "Open in Octomus" in the tombstone (wasm)
...
impl TelemetryEventDesc for AgentManagementTelemetryEventDiscriminants {
    ...
    fn description(&self) -> &'static str {
        match self {
            ...
            #[cfg(target_family = "wasm")]
            Self::TombstoneOpenInWarp => "User clicked Open in Octomus in the tombstone",
...
octomus_core::register_telemetry_event!(AgentManagementTelemetryEvent);
