...
const DEFAULT_LEARN_MORE_URL: &str =
    "https://docs.octomus.dev/agent-platform/cloud-agents/harnesses/authentication/";
const CODEX_LEARN_MORE_URL: &str =
    "https://docs.octomus.dev/agent-platform/cloud-agents/harnesses/authentication/#connecting-codex-credentials";
const CLAUDE_LEARN_MORE_URL: &str =
    "https://docs.octomus.dev/agent-platform/cloud-agents/harnesses/authentication/#connecting-claude-code-credentials";
