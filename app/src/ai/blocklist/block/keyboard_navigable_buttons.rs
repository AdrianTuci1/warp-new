...
pub type ButtonBuilder = Box<dyn Fn(bool, &octomusui::AppContext) -> Button>;
...
impl KeyboardNavigableButtonBuilder {
    pub fn new(
        button_builder: impl Fn(bool, &octomusui::AppContext) -> Button + 'static,
...
pub fn simple_navigation_button<A: octomusui::Action + Clone + 'static>(
    text_label: String,
...
pub fn rich_navigation_button<A: octomusui::Action + Clone + 'static>(
    text_label: String,
...
impl View for KeyboardNavigableButtons {
    ...
    fn keymap_context(&self, _app: &AppContext) -> octomusui::keymap::Context {
