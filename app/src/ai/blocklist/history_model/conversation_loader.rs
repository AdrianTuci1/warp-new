...
fn box_future<F>(f: F) -> octomusui::r#async::BoxFuture<'static, Option<CloudConversationData>>
where
    F: Future<Output = Option<CloudConversationData>> + octomusui::r#async::Spawnable,
{
    cfg_if::cfg_if! {
...
impl BlocklistAIHistoryModel {
    ...
    pub fn load_conversation_data(
        ...
        conversation_id: AIConversationId,
        ctx: &AppContext,
    ) -> octomusui::r#async::BoxFuture<'static, Option<CloudConversationData>> {
