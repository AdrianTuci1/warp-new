...
use octomusui::keymap::{EditableBinding, FixedBinding, Keystroke};
...
impl CodeDiffView {
    ...
    fn render_scroll_icon_for_inline_banner(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let icon = octomusui::elements::Icon::new(
            Icon::ArrowDown.into(),
    ...
    fn render_header_contents(
        ...
        // config and a Octomus config at once) show no badge to avoid misleading attribution.
...
impl BackingView for CodeDiffView {
    ...
    fn render_header_content(
        ...
        view::HeaderContent::Standard(view::StandardHeader {
            ...
            title_style: None,
            title_clip_config: octomusui::text_layout::ClipConfig::start(),
