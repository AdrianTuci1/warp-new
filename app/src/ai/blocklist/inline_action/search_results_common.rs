...
use octomusui::{AppContext, EventContext, SingletonEntity};
...
pub fn render_search_results_header(
    ...
    is_expanded: bool,
    mouse_state: octomusui::elements::MouseStateHandle,
    ...
    octomusui::elements::Hoverable::new(mouse_state, |_| inner)
