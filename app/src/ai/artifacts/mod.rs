...
pub fn open_screenshot_lightbox<V: octomusui::View>(
    artifact_uids: &[String],
    ctx: &mut octomusui::ViewContext<V>,
) {
...
pub fn download_file_artifact<V: octomusui::View>(
    artifact_uid: &str,
    ctx: &mut octomusui::ViewContext<V>,
) {
    let ai_client = ServerApiProvider::handle(ctx).as_ref(ctx).get_ai_client();
...
fn open_file_download_result<V: octomusui::View>(
    artifact_uid: &str,
...
#[cfg(feature = "local_fs")]
fn open_file_download_picker<V: octomusui::View>(
    artifact: ArtifactDownloadResponse,
    ctx: &mut octomusui::ViewContext<V>,
) {
    ...
    ctx.open_save_file_picker(
        move |path_opt: Option<String>, _me: &mut V, ctx: &mut octomusui::ViewContext<V>| {
...
fn show_file_download_toast<V: octomusui::View>(
    artifact_uid: &str,
