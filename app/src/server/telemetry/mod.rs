...
pub fn clear_event_queue() {
    let _ = octomusui::telemetry::flush_events();
}
...
impl TelemetryApi {
    ...
    pub async fn flush_events(&self, settings_snapshot: PrivacySettingsSnapshot) -> Result<usize> {
        let events = octomusui::telemetry::flush_events();
    ...
    pub async fn send_telemetry_event(
        ...
        anonymous_id: String,
        event: impl octomus_core::telemetry::TelemetryEvent,
        settings_snapshot: PrivacySettingsSnapshot,
    ) -> Result<()> {
        let event = octomusui::telemetry::create_event(
