...
impl Display for ServerExperiment {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        let str = match self {
            ...
            Self::TmuxSshOctomusificationControl => "TMUX_SSH_WARPIFICATION_CONTROL",
            Self::TmuxSshOctomusificationExperiment => "TMUX_SSH_WARPIFICATION_EXPERIMENT",
...
impl ServerExperiment {
    pub fn from_string(s: String) -> Result<Self> {
        match s.as_str() {
            ...
            "TMUX_SSH_WARPIFICATION_CONTROL" => Ok(Self::TmuxSshOctomusificationControl),
            "TMUX_SSH_WARPIFICATION_EXPERIMENT" => Ok(Self::TmuxSshOctomusificationExperiment),
