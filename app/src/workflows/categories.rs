    ...
    pub fn new(
        ...
        categorized_workflows.insert(
            ...
            Self::categorize_workflows(
                global_workflows()
                    .into_iter()
                    .map(Workflow::from) // convert from the public-facing Workflow type to the octomus-internal Workflow type
        ...
        workflow_documentation_link_text.add_child(
            appearance
                ...
                .link(
                    ...
                    Some(
                        "https://docs.octomus.dev/knowledge-and-collaboration/octomus-drive/workflows"
                            .into(),
                    ),
                    None,
