...
pub struct DataSource {
    searcher: Box<dyn OctomusDriveSearcher>,
}

impl DataSource {
    #[cfg(not(target_family = "wasm"))]
    pub fn new(ctx: &mut ModelContext<Self>) -> Self {
        if octomus_core::features::FeatureFlag::UseTantivySearch.is_enabled() {
    ...
    pub fn new_fuzzy(ctx: &mut ModelContext<Self>) -> Self {
        ...
        let mut searcher = Box::new(FuzzyOctomusDriveSearcher::default());
    ...
    fn new_full_text(ctx: &mut ModelContext<Self>) -> Self {
        ctx.subscribe_to_model(&CloudModel::handle(ctx), Self::handle_cloud_object_updated);
        let mut searcher = Box::new(full_text_searcher::FullTextOctomusDriveSearcher::new(
...
#[derive(Default)]
struct FuzzyOctomusDriveSearcher {
...
impl OctomusDriveSearcher for FuzzyOctomusDriveSearcher {
    fn insert_searchable_object(
        &mut self,
        object: &dyn CloudObject,
        object_type: ObjectType,
...
mod full_text_searcher {
    ...
    use octomus_search_core::define_search_schema;
    ...
    use crate::notebooks::CloudNotebook;
    use crate::search::command_palette::octomus_drive::data_source::OctomusDriveSearcher;
    use crate::search::command_palette::octomus_drive::env_var_collection_search_item::{
        EnvVarCollectionSearchItem, ENV_VAR_NAME_SEPARATOR,
    };
    use crate::search::command_palette::octomus_drive::notebook_search_item::NotebookSearchItem;
    use crate::search::command_palette::octomus_drive::workflow_search_item::WorkflowSearchItem;
    use crate::search::env_var_collections::fuzzy_match::FuzzyMatchEnvVarCollectionResult;
    use crate::search::notebooks::fuzzy_match::FuzzyMatchNotebookResult;
    ...
    /// Memory budget for the search index of octomus drive.
    /// Octomus could potentially have a lot of objects, so we increase it from the default of 50MB to 100MB
    ...
    pub(crate) struct FullTextOctomusDriveSearcher {
    ...
    impl FullTextOctomusDriveSearcher {
    ...
    impl OctomusDriveSearcher for FullTextOctomusDriveSearcher {
        fn insert_searchable_object(
            &mut self,
            object: &dyn CloudObject,
            object_type: ObjectType,
