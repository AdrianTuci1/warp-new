...
use crate::terminal::resizable_data::{ModalType, ResizableData, DEFAULT_OCTOMUS_AI_WIDTH};
...
pub fn init(app: &mut AppContext) {
    ...
    app.register_editable_bindings([
        EditableBinding::new(
            ...
            "Focus Terminal Input From Octomus AI",
...
impl AIAssistantPanelView {
    pub fn new(
            ...
            .get_handle(ctx.window_id(), ModalType::WarpAIWidth)
        {
            Some(handle) => handle,
            None => {
                log::error!("Couldn't retrieve octomus ai resizable state handle.");
                resizable_state_handle(DEFAULT_OCTOMUS_AI_WIDTH)
            }
        };
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        stack.add_positioned_overlay_child(
            ...
            OffsetPositioning::offset_from_parent(
                ...
                octomusui::elements::ParentOffsetBounds::Unbounded,
