...
impl View for ExecutionProfileView {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
                ...
                .with_child(
                    Container::new({
                        ...
                        permissions_column.add_child(with_standard_vertical_margin(
                            render_bool_permission_line_with_icon(
                                Icon::Compass,
                                "Auto-sync plans to Octomus Drive:",
                                profile.autosync_plans_to_octomus_drive,
                                appearance,
                                is_any_ai_enabled,
                            ),
                        ));
        ...
        .with_border(
            octomusui::elements::Border::new(1.).with_border_fill(appearance.theme().outline()),
        )
        .with_corner_radius(octomusui::elements::CornerRadius::with_all(
            ...
            items_vec
                ...
                .map(|item| {
                    Container::new(
                        ...
                        .with_background(appearance.theme().surface_2())
                        .with_border(
                            octomusui::elements::Border::all(1.)
                                .with_border_fill(appearance.theme().outline()),
                        )
                        .with_corner_radius(octomusui::elements::CornerRadius::with_all(
                            octomusui::elements::Radius::Pixels(3.),
                        ))
    ...
    Container::new(
        Flex::row()
            ...
            .with_child(
                Container::new(
                    ConstrainedBox::new(
                        icon.to_octomusui_icon(if is_ai_enabled {
                            appearance
                                .theme()
