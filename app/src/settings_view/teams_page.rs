...
impl TeamsWidget {
    ...
    fn render_team_member_cost_info(
        ...
        let prorated_message = if has_admin_permissions {
            "You'll be charged for a portion of the team member's usage of Octomus."
        } else {
            "Your admin will be charged for a portion of the team member's usage of Octomus."
        };
    ...
    fn render_discoverability_toggle_section(
        ...
        let team_discoverability_instructions =
            format!("Allow Octomus users with an @{domain} email to find and join the team.");
    ...
    fn render_create_team_page(
        ...
        if view.auth_state.is_on_work_domain().unwrap_or_default() {
            ...
            let checkbox_row_text = if let Some(domain) = view.auth_state.user_email_domain() {
                ...
                "Allow Octomus users with the same email domain as you to find and join the team."
                    .to_string()
            };
