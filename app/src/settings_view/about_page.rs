...
use octomusui::{AppContext, Entity, View, ViewContext, ViewHandle};
...
impl SettingsWidget for AboutPageWidget {
    ...
    fn render(
        ...
        let image_path = if theme.inferred_color_scheme() == ColorScheme::LightOnDark {
            "bundled/svg/octomus-logo-with-light-title.svg"
        } else {
            "bundled/svg/octomus-logo-with-dark-title.svg"
        };
