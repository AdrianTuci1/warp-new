...
impl GlobalBufferModel {
    ...
    fn has_pending_batch_for_test(&self, file_id: octomus_util::file::FileId) -> bool {
    ...
    fn pending_batch_edit_count_for_test(&self, file_id: octomus_util::file::FileId) -> usize {
        self.buffers
            .get(&file_id)
    ...
    fn insert_pending_batch_for_test(
        &mut self,
        file_id: octomus_util::file::FileId,
