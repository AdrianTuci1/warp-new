...
const HERO_IMAGE_PATH: &str = "async/png/onboarding/openoctomus_launch_banner.png";
const REPO_URL: &str = "https://github.com/warpdotdev/octomus";
const CONTRIBUTING_URL: &str = "https://github.com/warpdotdev/octomus/blob/master/CONTRIBUTING.md";
