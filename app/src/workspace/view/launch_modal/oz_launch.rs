    ...
    fn content(&self) -> &'static str {
        match self {
            ...
            OzLaunchSlide::AgentManagement => {
                "View all of your agents across local and cloud sessions in the Warp app or at [oz.localhost:8080](https://oz.localhost:8080). Join live agent sessions, continue tasks locally, and steer agents with one click."
            }
            OzLaunchSlide::LaunchCredits => {
