...
use octomusui::{Entity, EntityId, ModelContext, SingletonEntity, WindowId};
...
/// in Octomus from Finder, or when starting from a cloud object). In that case, the `ActiveSession`
