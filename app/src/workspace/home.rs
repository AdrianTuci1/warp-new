...
const WARP_HOME_TITLE: &str = "Welcome to Octomus on Web";
const WARP_HOME_CONTENT: &str = r#"
Welcome to Octomus on Web - your browser-based home for Octomus! 
Use Octomus on Web to:
* Join Shared Sessions
* Create, View, and Edit Local Storage Objects
* Manage your Octomus Settings

Octomus on Web can also be used by your teammates and peers who don't have Octomus downloaded yet to view your shared sessions, notebooks, and workflows."#;
