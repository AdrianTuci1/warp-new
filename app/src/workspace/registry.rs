...
use octomusui::{AppContext, Entity, SingletonEntity, WeakViewHandle, WindowId};
...
impl WorkspaceRegistry {
    ...
    pub fn get(
        ...
        window_id: WindowId,
        app: &AppContext,
    ) -> Option<octomusui::ViewHandle<Workspace>> {
    ...
    pub fn all_workspaces(
        &self,
        app: &AppContext,
    ) -> Vec<(WindowId, octomusui::ViewHandle<Workspace>)> {
        self.workspaces
            .iter()
