...
const WARP_DRIVE_TITLE: &str = "Local Storage";
...
impl DriveIndex {
            ...
            |mouse_state| {
                ...
                if mouse_state.is_hovered() {
                    let tooltip = appearance
                        .ui_builder()
                        .tool_tip(String::from("Syncing Local Storage"));
    ...
    fn render_personal_limit_status(
        ...
        let header = Flex::row()
            ...
            .with_main_axis_alignment(MainAxisAlignment::SpaceBetween)
            .with_child(
                Text::new_inline("Local Storage".to_string(), appearance.ui_font_family(), 14.)
