...
use octomusui::platform::{FilePickerConfiguration, OperatingSystem};
...
impl ExportManager {
    ...
    fn handle_failure(
        ...
        let id = *export.key();
        // Don't send the error to Sentry, since it likely includes a user file path and their Octomus
