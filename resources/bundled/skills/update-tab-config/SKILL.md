...
4. Make sure you are editing the tab config that belongs to the user's current Octomus build/channel rather than assuming a single hardcoded base directory, then update it so it remains valid according to the `tab-configs` schema.
