...
#
# This script copies resources that should be bundled with Octomus into a
...
if ($env:GIT_RELEASE_TAG) {
    ...
    Write-Output "Writing bundled Octomus version metadata to $VersionMetadataPath"
...
$AdditionalLicenses = @(
    @{ Name = 'Alacritty (alacritty_terminal)'; License = 'Apache-2.0'; Path = 'crates\octomus_terminal\src\model\LICENSE-ALACRITTY' },
