...
description: Remove a feature flag after it has been rolled out and stabilized in the Octomus codebase.
---

# remove-feature-flag

Remove a feature flag after it has been rolled out and stabilized in the Octomus codebase.
...
Remove the variant from the `FeatureFlag` enum in `octomus_core/src/features.rs`:
...
```bash
rg "YourFeatureName" app/ octomus_core/
```
