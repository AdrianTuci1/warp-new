...
INJECTED="/tmp/octomus-stage2-master-$$.txt"
...
rm -f /tmp/octomus-stage2-master-*.txt

# Generam master prompt cu token-ul injectat direct
sed "s|__GH_TOKEN__|$GITHUB_TOKEN|g" .hermes-prompts/master-octomus-stage2.txt > "$INJECTED"
