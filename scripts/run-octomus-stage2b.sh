...
INJECTED="/tmp/octomus-stage2b-master-$$.txt"
...
mkdir -p .hermes-logs
rm -f /tmp/octomus-stage2b-master-*.txt

sed "s|__GH_TOKEN__|$GITHUB_TOKEN|g" .hermes-prompts/master-octomus-stage2b.txt > "$INJECTED"
...
echo "Prompt generat. Lansez Stage 2b (New Features: A11+A12+A14)..."
echo ""
