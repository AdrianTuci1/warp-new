...
/// Icon enum to be used within the app in place of the octomusui_core::elements::Icon directly. It
...
impl From<Icon> for &'static str {
    fn from(icon: Icon) -> &'static str {
        match icon {
            ...
            Icon::OctomusDrive => "bundled/svg/octomus.svg",
            Icon::Octomus => "bundled/svg/octomus-drive.svg",
            Icon::WarpLogoLight => "bundled/svg/octomus-logo-light.svg",
            ...
            Icon::Warping0 => "bundled/svg/octomus-loading-0.svg",
            Icon::Warping1 => "bundled/svg/octomus-loading-1.svg",
            Icon::Warping2 => "bundled/svg/octomus-loading-2.svg",
            Icon::Warping3 => "bundled/svg/octomus-loading-3.svg",
            Icon::Warping4 => "bundled/svg/octomus-loading-4.svg",
            Icon::Warping5 => "bundled/svg/octomus-loading-5.svg",
            Icon::Warping6 => "bundled/svg/octomus-loading-6.svg",
            Icon::Warping7 => "bundled/svg/octomus-loading-7.svg",
            Icon::Warping8 => "bundled/svg/octomus-loading-8.svg",
            Icon::Warping9 => "bundled/svg/octomus-loading-9.svg",
            Icon::Warping10 => "bundled/svg/octomus-loading-10.svg",
            Icon::Warping11 => "bundled/svg/octomus-loading-11.svg",
...
impl Icon {
    ...
    pub fn icon_for_key(key: &str) -> Option<WarpUiIcon> {
        match key {
            "⏎" => Some(Self::CornerDownLeft.to_octomusui_icon(Fill::black())),
            _ => None,
        }
    }
}
