...
impl ChannelState {
    pub fn init() -> Self {
        ...
        let app_id = AppId::new("dev", "octomus", "WarpOss");
        Self {
            channel,
    ...
    pub fn uses_staging_server() -> bool {
        ...
        url.host_str() == Some("staging.localhost")
    }
    ...
    ///
    /// This is a debugging tool for isolating development instances of Octomus, and is not
    ...
    /// served by octomus-server-rtc (e.g. the agent event SSE stream).
    ///
