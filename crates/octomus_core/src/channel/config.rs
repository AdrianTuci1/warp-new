...
pub struct ChannelConfig {
    ...
    /// Configuration for talking to Octomus's servers.
...
pub struct WarpServerConfig {
    ...
    /// The URL for the RTC server, which serves real-time updates for Octomus Drive objects.
...
impl WarpServerConfig {
    pub fn production() -> Self {
        Self {
            ...
            rtc_server_url: "ws://localhost:8080/rtc".into(),
            session_sharing_server_url: Some("ws://localhost:8080/sessions".into()),
...
impl OzConfig {
    pub fn production() -> Self {
        Self {
            oz_root_url: "http://localhost:8080".into(),
