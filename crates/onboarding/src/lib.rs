...
/// User-facing names of the Octomus Drive features enabled when the terminal
/// intention is selected with Octomus Drive turned on. Shared by the login slide's
/// skip-login confirmation dialog so the list stays in sync with any future
/// surfaces that need it.
pub const WARP_DRIVE_FEATURES: &[&str] = &["Octomus Drive", "Session Sharing"];
...
pub fn init(app: &mut octomusui_core::AppContext) {
