...
//!
//! ## How does a11y work in Octomus?
//! Because Octomus uses its own rust UI framework (octomusui), we don’t benefit from the built-in
...
pub struct AccessibilityContent {
    ...
    /// Frame support is a work-in-progress in Octomus and right now this field is omitted and not set.
