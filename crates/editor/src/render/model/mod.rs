...
use octomusui_core::text_layout::{CaretPosition, LayoutCache, Line, TextFrame};
use octomusui_core::text_selection_utils::{
...
/// passed to [`octomusui_core::text_layout::LayoutCache::layout_text()`].
///
...
impl<'a> Positioned<'a, Paragraph> {
    ...
    pub(super) fn draw_dashed_underline(
        ...
        for line in self.lines() {
            ...
            let dash = octomusui_core::scene::Dash {
            ...
            ctx.paint
                ...
                .with_border(
                    octomusui_core::scene::Border::bottom(UNDERLINE_THICKNESS)
