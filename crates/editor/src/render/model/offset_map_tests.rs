...
fn test_end_to_end() {
    ...
    use octomusui_core::elements::Fill;
    use octomusui_core::fonts::Cache as FontCache;
    use octomusui_core::text_layout::LayoutCache;
    ...
    App::test((), |mut app| async move {
        let mut font_cache = FontCache::new(Box::new(octomusui::platform::current::FontDB::new()));
