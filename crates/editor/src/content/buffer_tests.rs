...
fn test_inline_markdown_roundtrips() {
    ...
    let inputs = &[
        ...
        "[link1](https://localhost:8080)[**link2**](https://example.com)",
...
fn test_link_style_exact() {
    App::test((), |mut app| async move {
        ...
        buffer.update(&mut app, |buffer, ctx| {
            ...
            assert_eq!(
                buffer.content.debug(),
                "<text><a_www.google.com>li<a><a_www.localhost:8080>ne\\nb<a>lock"
            );
                    ...
                    StyledBufferBlock::Text(StyledTextBlock {
                        block: vec![
                            ...
                            StyledBufferRun {
                                run: "ne\n".to_string(),
                                text_styles: TextStylesWithMetadata::default()
                                    .link("www.localhost:8080".to_string()),
                                block_style: BufferBlockStyle::PlainText
                            }
                        ],
                        style: BufferBlockStyle::PlainText,
...
fn test_link_style_different_tag() {
    App::test((), |mut app| async move {
        ...
        buffer.update(&mut app, |buffer, ctx| {
            ...
            assert_eq!(
                buffer.content.debug(),
                "<text><a_www.google.com>g<a>n<a_www.localhost:8080>normal long text<a>ock"
            );
...
fn test_link_style_surrounded() {
    App::test((), |mut app| async move {
        ...
        buffer.update(&mut app, |buffer, ctx| {
            ...
            assert_eq!(
                buffer.content.debug(),
                "<text><a_www.google.com>li<a><a_www.localhost:8080>ne<a>\\nblock"
            );
...
fn test_unstyle_link_overlapping() {
    App::test((), |mut app| async move {
        ...
        buffer.update(&mut app, |buffer, ctx| {
            ...
            assert_eq!(
                buffer.content.debug(),
                "<text><a_www.google.com>lin<a><a_www.localhost:8080>e\\nb<a>lock"
            );
            ...
            assert_eq!(
                buffer.content.debug(),
                "<text><a_www.google.com>l<a>ine<a_www.localhost:8080>\\nb<a>lock"
            );
