//! Repository metadata utilities for Octomus.
//!
...
#[cfg(not(target_family = "wasm"))]
pub fn is_in_repo(path: &str, app: &octomusui_core::AppContext) -> bool {
...
pub fn is_in_repo(_path: &str, _app: &octomusui_core::AppContext) -> bool {
    false
}
