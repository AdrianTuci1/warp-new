...
/// The main Octomus process spawns this via the `ripgrep-search` CLI
...
mod process_impl {
    ...
    /// Spawns the octomus CLI with the `ripgrep-search` subcommand.
    fn spawn_search_process(
        ...
        cmd.arg(octomus_cli::ripgrep_search_subcommand())
