...
impl AuthState {
    ...
    /// Returns whether the user considered onboarded to Octomus.
    ...
    /// Anonymous users are real Octomus users, but have no providers linked in Firebase.
    ...
    /// originated from viewing Octomus on web.
