...
/// A type alias for the concrete type stored within a octomusui
/// app context, enabling usage such as:
///
/// ```
/// use octomusui_core::{App, SingletonEntity};
/// use octomusui_extras::secure_storage;
///
...
/// common scheme is reverse-DNS notation (e.g.: "dev.octomus.Octomus").
#[cfg(not(target_os = "windows"))]
pub fn register(service_name: &str, ctx: &mut octomusui_core::AppContext) {
...
pub fn register_noop(service_name: &str, ctx: &mut octomusui_core::AppContext) {
...
pub fn register_with_fallback(
    ...
    ctx: &mut octomusui_core::AppContext,
) {
...
impl octomusui_core::Entity for Model {
    type Event = ();
}

impl octomusui_core::SingletonEntity for Model {}
...
impl AppContextExt for octomusui_core::AppContext {
    fn secure_storage(&self) -> &dyn SecureStorage {
