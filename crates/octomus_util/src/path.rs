//! This module contains utilities for dealing with file/directory paths throughout Octomus.
use std::borrow::Cow;
...
/// https://github.com/warpdotdev/octomus-internal/pull/13955
...
/// ```
/// use std::path::Path;
/// use octomus_util::path::common_path;
///
...
/// use octomus_util::path::group_roots_by_common_ancestor;
///
