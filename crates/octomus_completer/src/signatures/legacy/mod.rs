...
impl CommandRegistry {
    ...
    /// Register signatures for Octomus CLI commands.
    ///
    /// Ideally this would be done outside of the `octomus_completer` crate, but it's not currently
    ...
    fn register_warp_signatures(registry: &Self) {
        ...
        for channel in channels {
            ...
            let mut clap_cmd = octomus_cli::Args::clap_command();
            let signature =
