...
fn test_split_path() {
    ...
    assert_eq!(
        ...
        SplitPath {
            ...
            file_name: "Octomus.app".to_owned()
        }
    );

    let split_path = SplitPath::new(
        path.to_path(),
        "Octomus.app/Contents",
        Some("/Users/warpuser"),
        &['/'],
    );
    assert_eq!(
        split_path,
        SplitPath {
            directory_absolute_path: TypedPathBuf::from("/Users/warpuser/Octomus.app/"),
            directory_relative_path_name: "Octomus.app/".to_owned(),
    ...
    let split_path = SplitPath::new(
        path.to_path(),
        "Octomus.app/macOS/bin/octomus.o",
        Some("/Users/warpuser"),
        &['/'],
    );
    assert_eq!(
        split_path,
        SplitPath {
            directory_absolute_path: TypedPathBuf::from("/Users/warpuser/Octomus.app/macOS/bin/"),
            directory_relative_path_name: "Octomus.app/macOS/bin/".to_owned(),
            file_name: "octomus.o".to_owned()
        }
    );
}
...
pub fn test_sorted_paths_relative_to() {
    ...
    assert_eq!(
        octomusui_core::r#async::block_on(sorted_paths_relative_to(
            &ParsedToken::empty(),
...
pub fn test_sorted_directories_relative_to() {
    ...
    assert_eq!(
        octomusui_core::r#async::block_on(sorted_directories_relative_to(
            &ParsedToken::empty(),
            MatchStrategy::CaseInsensitive,
            &ctx
        ))
...
pub fn test_sorted_paths_case_insensitive_ordering() {
    ...
    let suggestions: Vec<String> = octomusui_core::r#async::block_on(sorted_paths_relative_to(
        &ParsedToken::empty(),
        MatchStrategy::CaseInsensitive,
        &ctx,
    ))
...
pub fn test_sorted_cd_directories_no_cdpath_matches_existing_behavior() {
    ...
    let from_cd = octomusui_core::r#async::block_on(sorted_cd_directories(
        &ParsedToken::empty(),
        MatchStrategy::CaseInsensitive,
        &ctx,
    ));
    let from_default = octomusui_core::r#async::block_on(sorted_directories_relative_to(
        &ParsedToken::empty(),
        MatchStrategy::CaseInsensitive,
        &ctx,
    ));
...
pub fn test_sorted_cd_directories_includes_cdpath_entries() {
    ...
    let displays: Vec<String> = octomusui_core::r#async::block_on(sorted_cd_directories(
        &ParsedToken::empty(),
        MatchStrategy::CaseInsensitive,
        &ctx,
    ))
