...
use octomusui_core::elements::Stack;
...
fn main() -> octomusui_core::platform::app::TerminationResult {
    ...
    app_builder.run(move |ctx| {
        ...
        let font_family = octomusui_core::fonts::Cache::handle(ctx).update(ctx, |cache, _ctx| {
        ...
        ctx.add_window(octomusui_core::AddWindowOptions::default(), RootView::new);
    })
}
...
impl View for RootView {
    ...
    fn keymap_context(&self, _: &AppContext) -> octomusui_core::keymap::Context {
            ...
            switch::Params {
                ...
                options: switch::Options {
                    ...
                    label: Some(Box::new(move |appearance: &Appearance| {
                        octomusui_core::elements::Text::new(
                            "Switch",
        ...
        tooltip::Tooltip.render(
            ...
            tooltip::Params {
                ...
                options: tooltip::Options {
                    keyboard_shortcut: Some(octomusui_core::keymap::Keystroke {
                        ctrl: true,
                        key: "k".to_string(),
                        ..Default::default()
                    }),
                ...
                self.default_button_row.default.render(
                    ...
                    button::Params {
                        ...
                        options: button::Options {
                            keystroke: Some(octomusui_core::keymap::Keystroke {
                                ctrl: true,
                                key: "k".to_string(),
                                ..Default::default()
                            }),
        ...
        self.dialog.render(
            ...
            dialog::Params {
                ...
                options: dialog::Options {
                    ...
                    dismiss_keystroke: Some(octomusui_core::keymap::Keystroke {
                        key: "escape".to_string(),
                        ..Default::default()
                    }),
