...
/// Events emitted from Octomus on Web to the host JavaScript app.
///
/// These must stay in sync with the [`WarpEvent` TypeScript type](https://github.com/warpdotdev/octomus-server/blob/develop/client/src/octomus-client/index.ts).
