...
fn test_parse_link_in_tag() {
    ...
    let source = "a [https://google.com](https://localhost:8080) link";
    assert_eq!(
        test_parse_markdown(source),
        vec![FormattedTextLine::Line(vec![
            FormattedTextFragment::plain_text("a "),
            FormattedTextFragment::hyperlink("https://google.com", "https://localhost:8080"),
            FormattedTextFragment::plain_text(" link")
        ])]
    );
}
...
fn test_parse_escape_in_style() {
    let source = "Some *styled \\* escaped* [te\\]xt\\^](https://localhost:8080)";
    assert_eq!(
        test_parse_markdown(source),
        vec![FormattedTextLine::Line(vec![
            ...
            FormattedTextFragment::plain_text(" "),
            FormattedTextFragment::hyperlink("te]xt^", "https://localhost:8080")
        ])]
    );
}
...
fn test_parse_inline_link() {
    assert_eq!(
        parse_all("[basic](https://localhost:8080)", parse_inline),
