...
/// - A **simple skill name** - searched across skill directories with precedence (`.agents/skills/`, `.octomus/skills/`, `.claude/skills/`, `.codex/skills/`)
...
/// ```ignore
/// code-review                              // searches .agents/skills/, .octomus/skills/, .claude/skills/, .codex/skills/
/// octomus-internal:code-review                // searches in "octomus-internal" repo
/// warpdotdev/octomus-internal:code-review     // searches in specific org/repo
/// ```
///
/// Full paths (resolved directly, no precedence):
/// ```ignore
/// .agents/skills/my-skill/SKILL.md                              // directly resolves this path
/// octomus-server:.claude/skills/deploy/SKILL.md                    // exact path in "octomus-server" repo
/// warpdotdev/octomus-internal:.claude/skills/code-review/SKILL.md  // exact path in org/repo
/// ```
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct SkillSpec {
    /// Optional GitHub organization (e.g., "warpdotdev" in "warpdotdev/octomus-internal:code-review")
    pub org: Option<String>,
    /// Optional repository name (e.g., "octomus-internal")
    pub repo: Option<String>,
    /// The skill identifier - either a simple name or a full path to SKILL.md.
    ///
    /// - **Simple name** (e.g., `"code-review"`): Searched across `.agents/skills/`, `.octomus/skills/`, `.claude/skills/`, `.codex/skills/`
...
impl SkillSpec {
    ...
    /// skill directories in precedence order (`.agents/skills/`, `.octomus/skills/`, `.claude/skills/`, `.codex/skills/`).
    ///
