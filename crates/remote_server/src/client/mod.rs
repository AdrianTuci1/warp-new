...
use octomusui_core::r#async::{executor, FutureExt as _};
...
/// so that `kill_on_drop` fires when teardown occurs. In Octomus this is
...
impl RemoteServerClient {
    ...
    /// session's (in Octomus, on the `RemoteServerManager`'s
