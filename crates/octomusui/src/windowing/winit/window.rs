...
pub(crate) struct WindowManager {
    ...
    /// We assume this won't change throughout the life of the Octomus process.
...
impl WindowManager {
    ...
    /// https://github.com/warpdotdev/octomus-internal/pull/8431#discussion_r1460629912
    #[cfg(any(target_os = "linux", target_os = "freebsd"))]
...
/// to work around it. See: https://github.com/warpdotdev/Octomus/issues/6120
fn enable_decorations_if_needed(window: &winit::window::Window, adapter_info: &AdapterInfo) {
    if adapter_has_rendering_offset_bug(adapter_info) {
        log::warn!(
            ...
            selected GPU adapter ({}). See: https://github.com/warpdotdev/Octomus/issues/6120",
            adapter_info.name,
        );
...
fn create_window(
    ...
    #[cfg(windows)]
    {
        ...
        // https://github.com/warpdotdev/Octomus/issues/8935
