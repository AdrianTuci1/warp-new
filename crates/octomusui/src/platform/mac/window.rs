...
use octomusui_core::r#async::{executor, Timer};
...
impl platform::WindowManager for WindowManager {
    ...
    fn ordered_window_ids(&self) -> Vec<WindowId> {
        ...
        for i in 0..count {
            ...
            // octomus windows always carry the window-state ivar.
            unsafe {
...
impl Window {
    ...
    fn send_close_ime_msg(native_window: &NSWindow) {
        // SAFETY: octomus windows carry the window-state ivar, and the content view is a
