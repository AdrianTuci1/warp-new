...
lazy_static! {
    ...
    /// 22.1.2, in practice, Octomus windows don't render properly until 24.0.2.
...
/// Returns whether or not the provided adapter is an unsupported Nvidia driver version for octomusui
/// to render properly.
...
/// octomusui to render properly. Currently, we limit this to "Intel UHD Graphics 620", but we do have
...
/// alignment.
///
/// See: https://github.com/warpdotdev/Octomus/issues/6120
pub fn adapter_has_rendering_offset_bug(adapter_info: &wgpu::AdapterInfo) -> bool {
    ...
    // https://github.com/warpdotdev/Octomus/issues/6120.
    let affected_models = [
...
/// https://github.com/warpdotdev/octomus/issues/10618
/// https://github.com/warpdotdev/octomus/issues/4879
...
/// (Vulkan llvmpipe) adapter that may not work properly with octomusui.
...
fn adapter_stability_sort_func(
    ...
    // Same with Nvidia drivers, though this is only an issue with a Wayland window server.
        ...
        log::warn!(
            ...
            http://localhost:8080/docs/help/known-issues#linux-1",
