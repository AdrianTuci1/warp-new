...
use octomus::integration_testing::view_getters::assert_no_views_of_type;
use octomus::pane_group::PaneGroup;
use octomus::terminal::model::bootstrap::BootstrapStage;
use octomus::terminal::shell::ShellType;
use octomus::terminal::TerminalView;
...
pub fn test_ctrl_d_handled_by_read_during_bootstrapping() -> Builder {
    new_builder()
        .set_should_run_test(|| {
            ...
            // We need to fix https://github.com/warpdotdev/Octomus/issues/1869 before
