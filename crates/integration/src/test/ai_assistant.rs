...
use octomus::integration_testing::view_getters::ai_assistant_panel_view;
use octomusui_core::async_assert;

use super::new_builder;
use crate::Builder;

/// Checks if the Ask Octomus AI keybinding works correctly when a block is selected.
/// This is a regression test: https://linear.app/warpdotdev/issue/WAR-6758/octomus-ai-ask-from-block-keybinding-doesnt-work-as-expected.
pub fn test_ask_octomus_ai_keybinding_for_selected_block() -> Builder {
    new_builder()
        ...
        .with_step(
            new_step_with_default_assertions("select block")
                ...
                .add_named_assertion("ask octomus ai from selected block", |app, window_id| {
                    let ai_assistant_panel = ai_assistant_panel_view(app, window_id);
                    ai_assistant_panel.read(app, |view, ctx| {
                        let expected_code_block = "```octomus\nfoo\n```";
