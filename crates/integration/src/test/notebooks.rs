...
use octomus::integration_testing::command_palette::open_command_palette_and_run_action;
use octomus::integration_testing::notebook::{
    ...
    assert_open_in_octomus_banner_open, create_a_personal_notebook,
...
use octomus::integration_testing::tab::{assert_pane_title, assert_tab_title};
...
pub fn test_open_in_octomus_banner() -> Builder {
    new_builder()
        .with_setup(|utils| {
        ...
        .with_step(
            ...
            .add_assertion(assert_open_in_octomus_banner_open(0, 0)),
        )
        .with_step(
            new_step_with_default_assertions("Click Open in Octomus banner")
                .with_click_on_saved_position_fn(|app, window_id| {
                    let view = terminal_view(app, window_id, 0, 0);
                    format!("open_in_octomus_banner_button_{}", view.id())
                }),
        )
        .with_step(
