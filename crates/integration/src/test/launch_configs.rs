...
use octomus::integration_testing::settings::set_window_custom_size;
...
use octomus::integration_testing::type_getters::get_launch_config_ui_location;
use octomus::integration_testing::window::assert_num_windows_open;
use octomus::integration_testing::workspace::{assert_focused_tab_index, assert_tab_count};
use octomus::integration_testing::{self};
use octomus::search::command_palette::launch_config;
use octomus::search::data_source::Query;
use octomus::search::SyncDataSource;
use octomus::workspace::NEW_TAB_BUTTON_POSITION_ID;
use octomusui_core::integration::{AssertionOutcome, TestStep};
use octomusui_core::{async_assert, ModelHandle};

use super::{assert_approx_eq, new_builder, TEST_ONLY_ASSETS};
use crate::Builder;

/// Adds a launch config to the mocked out octomus config directory and verifies that
            ...
            new_step_with_default_assertions("Opening a configuration template").with_action(
                move |app, _, _| {
                    app.dispatch_global_action(
                        ...
                        octomus::root_view::OpenLaunchConfigArg {
                            launch_config:
                                octomus::launch_configs::launch_config::make_mock_single_window_launch_config(),
...
pub fn test_launch_config_single_child_branch() -> Builder {
    use octomus::launch_configs::launch_config::{
