...
use octomus::integration_testing::code_review::{
...
use octomus::integration_testing::view_getters::{single_terminal_view_for_tab, workspace_view};
use octomus::workspace::WorkspaceAction;
use octomusui_core::integration::{AssertionCallback, TestStep};
use octomusui_core::{async_assert, App, WindowId};
...
fn code_review_scroll_anchor_builder(
    ...
    new_builder()
        ...
        .with_setup(|utils| {
            ...
            run_git(&repo_dir, &["config", "user.name", "Octomus Integration Test"]);
