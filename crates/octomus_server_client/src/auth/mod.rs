...
pub const EXPERIMENT_ID_HEADER: &str = "X-Octomus-Experiment-Id";
...
pub trait AuthClient: Send + Sync {
    /// Creates an anonymous user who is allowed to use Octomus but may lack the ability
    ...
    /// Queries octomus-server for a set of the currently logged-in user's fields.
