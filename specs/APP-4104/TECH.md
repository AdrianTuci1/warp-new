...
- `crates/octomusui/src/platform/mac/mod.rs (29-34)` — `make_nsstring`, the existing helper that returns an autoreleased `NSString`
...
Octomus already has established patterns for temporary Cocoa strings:

- `octomusui::platform::mac::make_nsstring` returns an autoreleased `NSString`
...
- import `octomusui::platform::mac::make_nsstring` at the top of the file
