...
- `octomus_core/src/features.rs` — `FeatureFlag` definitions and dogfood/default channel enablement
...
Add a dedicated feature flag named `BlocklistMarkdownTableRendering` and wire it through the normal Octomus feature-flag plumbing:
...
- add the new enum variant in `octomus_core/src/features.rs`
