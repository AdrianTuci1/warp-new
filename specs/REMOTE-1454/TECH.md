...
## Relevant code
- `crates/octomus_features/src/lib.rs:757,826` — `FeatureFlag::AgentHarness`, `FeatureFlag::CloudModeSetupV2`.
...
- `octomus_cli::agent::Harness` (`crates/octomus_cli/src/agent.rs:120-131`) — `Oz`, `Claude`, `Gemini`.
## Current state
